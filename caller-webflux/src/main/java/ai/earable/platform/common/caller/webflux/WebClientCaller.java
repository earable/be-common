package ai.earable.platform.common.caller.webflux;

import ai.earable.platform.common.exception.EarableException;
import ai.earable.platform.common.exception.ErrorDetails;
...
public class WebClientCaller implements Caller{
    ...
    private EarableException convertFrom(ErrorDetails errorDetails){
        ...
        return new EarableException(errorDetails.getHttpStatusCode(),
                errorDetails.getEarableErrorCode(), errorDetails.getDetails());
    }
}
